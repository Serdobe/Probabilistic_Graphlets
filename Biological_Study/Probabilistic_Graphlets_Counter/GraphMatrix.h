...
class GraphMatrix : public Graph {
 private:
  ...
  //New characteristic of the matrix of type "GraphMatrix":

  vector<vector<float>> Probability_Matrix;
 ...
 public:
  ...
  ///Functions Related with probabilities /////////////////////////////////////////////////////////////////////////////////

  //1. Function to read and fill matrix of probabilities:

  void make_probabilities_Matrix(Graph *g,vector<int> a, vector<int> b, int max, vector<float> c);

  //2. Function to return a concrete probability in the matrix:

  float return_probability(int row, int column); //Return info of probability in the matrix of probabilities

  //3. Function to return the whole matrix of probabilities:

  vector<vector<float>> return_Probability_Matrix(){return this -> Probability_Matrix;};
