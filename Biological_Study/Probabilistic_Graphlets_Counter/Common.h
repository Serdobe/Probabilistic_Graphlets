...
class Global {
 public:
  ...
  //For probabilities (Check if we should put probability matrix in this section)

  static bool show_probabilities;
  static bool show_graphlet_zero;
  static FILE *probabilities_file_Total_Nodes;
  static FILE *probabilities_file_Orbit_Node;

  static bool show_paral;
  static int num_from;
  static int num_to;
